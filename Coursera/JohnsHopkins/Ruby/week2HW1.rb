#This weeks assignment was to come up with a long chain method to provide a sample selection of numbers that are divisible by 3, greater than 5000, and reverse sorted.
...
p arr.select { |element| element % 3 == 0 }.reject{|i| i < 5000}.sort.reverse
