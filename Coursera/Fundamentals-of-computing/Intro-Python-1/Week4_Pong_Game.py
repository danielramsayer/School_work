...
def new_game():
    ...
    spawn_ball(RIGHT if random.randint(0,1) == 0 else LEFT)
...
def draw(canvas):
    ...
    if ball_pos[0] <= (PAD_WIDTH + BALL_RADIUS):
        if ball_pos[1] < (paddle1_pos - HALF_PAD_HEIGHT) or ball_pos[1] > (paddle1_pos + HALF_PAD_HEIGHT):
            ...
            ball_vel[0] = -ball_vel[0] * .5 # This piece speeds up the ball by 5%
    ...
    # draw scores
    canvas.draw_text(str(score1), (125, 40), 40, "white")
