...
function About(props) {
        ...
        <Media className="m-5">
          ...
          <Media body="body">
            <Media heading="heading">
              <CardTitle>{eachProfile.name}</CardTitle>
            </Media>
            <CardText>{eachProfile.designation}</CardText>
            <CardText>{eachProfile.description}</CardText>
          </Media>
        </Media>
      )
    });
  ...
  return (<div className="container">
    ...
    <div className="row row-content">
      ...
      <div className="col-12">
        <Media list="list">
          <RenderLeaders profile={props.leaders} />
        </Media>
      </div>
    </div>
  </div>);
